...
from src.utils import rename_tickers
from src.coingecko import coingecko_ticker_mapping 
...
def routegetalltickers():
    ...
    rename_tickers(final_ticker_infovrsc, coingecko_ticker_mapping["VRSC"])
    rename_tickers(final_ticker_infodai, coingecko_ticker_mapping["DAI"])
    rename_tickers(final_ticker_infoeth, coingecko_ticker_mapping["ETH"])
    rename_tickers(final_ticker_infomkr, coingecko_ticker_mapping["MKR"])
    rename_tickers(final_ticker_infotbtc, coingecko_ticker_mapping["BTC"])
